...
function constraint_item_count_shadow_aux(model::Model,
                                          parameters::Params,
                                          selected,
                                          minItems::Int,
                                          maxItems::Int = minItems)
...
function constraint_item_count_aux(model::Model,
                                   parameters::Params,
                                   selected,
                                   minItems::Int,
                                   maxItems::Int = minItems)
...
function constraint_item_count(model::Model,
                               parameters::Params,
                               selected,
                               minItems::Int,
                               maxItems::Int = minItems)
    constraint_item_count_aux(model::Model,
                              parameters::Params,
                              selected,
                              minItems::Int,
                              maxItems::Int)
    constraint_item_count_shadow_aux(model::Model,
                                     parameters::Params,
                                     selected,
                                     minItems::Int,
                                     maxItems::Int)
...
function constraint_item_sum_shadow_aux(model::Model,
                                        parameters::Params,
                                        vals,
                                        minVal,
                                        maxVal = minVal)
...
function constraint_item_sum_aux(model::Model,
                                 parameters::Params,
                                 vals,
                                 minVal,
                                 maxVal = minVal)
...
function constraint_item_sum(model::Model,
                             parameters::Params,
                             vals,
                             minVal,
                             maxVal = minVal)
...
function objective_match_characteristic_curve!(model::Model, parameters::Params)
    ...
    return constraint_TCC_shadow_aux(model::Model, parameters::Params)
end
...
function objective_match_information_curve!(model::Model, parameters::Params)
    ...
    return constraint_ICC_shadow_aux(model::Model, parameters::Params)
end
